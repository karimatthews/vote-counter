...
class PollsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poll" do
    assert_difference('Poll.count') do
      post polls_url, params: { poll: { blind: @poll.blind, title: @poll.title, voting_method: @poll.voting_method } }
    end
  ...
  test "should update poll" do
    patch poll_url(@poll), params: { poll: { blind: @poll.blind, title: @poll.title, voting_method: @poll.voting_method } }
